...
```{r extracreditfig, out.width='100%'}
...
```{r fig1c, message=F, warning=F, out.width='100%'}
#---------------WRITE YOUR CODE HERE#---------------#
...
```{r fig1d, out.width='100%', message=F, warning=F}
#---------------WRITE YOUR CODE HERE#---------------#
...
```{r fig2e, message=F, warning=F, out.width='100%'}
#---------------WRITE YOUR CODE HERE#---------------#
...
```{r fig2f, message=F, warning=F, out.width='100%'}
#---------------WRITE YOUR CODE HERE#---------------#
